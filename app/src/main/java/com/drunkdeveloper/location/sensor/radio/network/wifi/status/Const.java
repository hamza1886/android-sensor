...
public class Const {
    ...
    public static final String AGPS_DATA_EXPIRED = "com.drunkdeveloper.location.sensor.radio.network.wifi.status.AGPS_DATA_EXPIRED";
    public static final String DOWNLOAD_RECEIVER_REGISTERED = "com.drunkdeveloper.location.sensor.radio.network.wifi.status.DOWNLOAD_RECEIVER_REGISTERED";
    ...
    /**
     * Key for a {@link android.support.v4.os.ResultReceiver}
     */
