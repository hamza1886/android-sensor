...
public class LatLng {
     ...
     * @param longitude the longitude in degrees. Must be between -180.0 and 180.0
     *                  inclusive. -180.0 and 180.0 are effectively equivalent.
     * @throws IllegalArgumentException if either the given latitude or the given longitude are invalid.
     * @since 1.0
     */
     ...
     * @param longitude the longitude in degrees. Must be between -180.0 and 180.0
     *                  inclusive. -180.0 and 180.0 are effectively equivalent.
     * @param height    the perpendicular height above the reference ellipsoid.
     * @throws IllegalArgumentException if either the given latitude or the given longitude are invalid.
     * @since 1.1
     */
     ...
     * WGS84 datum.
     *
     * @param latitudeDegrees  the degrees part of the latitude. Must be 0 <= latitudeDegrees <=
     *                         90.0.
     * @param latitudeMinutes  the minutes part of the latitude. Must be 0 <= latitudeMinutes <
     *                         60.0.
     * @param latitudeSeconds  the seconds part of the latitude. Must be 0 <= latitudeSeconds <
     *                         60.0.
     * @param northSouth       whether the latitude is north or south of the equator. One of
     *                         LatLng.NORTH or LatLng.SOUTH.
     * @param longitudeDegrees the degrees part of the longitude. Must be 0 <= longitudeDegrees <=
     *                         90.0.
     * @param longitudeMinutes the minutes part of the longitude. Must be 0 <= longitudeMinutes <
     *                         60.0.
     * @param longitudeSeconds the seconds part of the longitude. Must be 0 <= longitudeSeconds <
     *                         60.0.
     * @param eastWest         whether the longitude is east or west of the prime meridian. One
     ...
     *                         of LatLng.EAST or LatLng.WEST.
     * @param height           the perpendicular height above the reference ellipsoid.
     * @param datum            the datum that this reference is based on.
     * @throws IllegalArgumentException if any of the parameters are invalid.
     * @since 1.1
     */
    public LatLng(int latitudeDegrees, int latitudeMinutes,
     ...
     * @throws NotDefinedOnUTMGridException if an attempt is made to convert a LatLng that falls outside the
     ...
     * LatLng.
     *
     * @param ll the LatLng object to measure the distance to.
