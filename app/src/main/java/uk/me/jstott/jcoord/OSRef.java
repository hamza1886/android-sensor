...
public class OSRef extends CoordinateSystem {
     ...
     *
     * @param easting  the easting in metres. Must be greater than or equal to 0.0 and
     *                 less than 800000.0.
     * @param northing the northing in metres. Must be greater than or equal to 0.0 and
     *                 less than 1400000.0.
     * @throws IllegalArgumentException if either the easting or the northing are invalid.
     * @since 1.0
     */
     ...
     * @param easting the easting in metres. Must be greater than or equal to 0.0 and
     *                less than 800000.0.
     * @throws IllegalArgumentException if the easting is invalid.
     */
     ...
     * @param northing the northing in metres. Must be greater than or equal to 0.0 and
     *                 less than 1400000.0.
     * @throws IllegalArgumentException if either the northing is invalid.
     */
