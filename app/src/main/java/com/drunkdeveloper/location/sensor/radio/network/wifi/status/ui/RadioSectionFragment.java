...
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTower;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTowerCdma;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTowerGsm;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTowerListCdma;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTowerListGsm;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTowerListLte;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTowerLte;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.WifiCapabilities;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.WifiScanResultComparator;
...
public class RadioSectionFragment extends Fragment {
     ...
     * {@link com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTower#UNKNOWN}, then the
     ...
     * input value is
     * {@link com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTower#DBM_UNKNOWN}, then
     ...
     * @param signalStrength The {@link android.telephony.SignalStrength} reported by a
