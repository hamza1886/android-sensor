        ...
        for (String key : allPrefs.keySet())
            if (key.startsWith(Const.KEY_PREF_LOC_PROV_STYLE)) {
                ...
                try {
                    ...
                    Log.w(this.getClass().getSimpleName(), String.format(Locale.getDefault(), "Cannot retrieve preference %s", key));
                }
                if (!styleName.equals(""))
                    addLocationProvider(String.format(Locale.getDefault(), getString(R.string.title_legend_map_prov), provName), styleName);
            }
