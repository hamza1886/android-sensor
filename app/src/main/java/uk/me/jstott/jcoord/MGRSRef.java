...
public class MGRSRef extends CoordinateSystem {
     ...
     *
     * @param utm      a UTM reference.
     * @param isBessel true if the parameters represent an MGRS reference using the
     ...
     *
     * @param utmZoneNumber the UTM zone number representing the longitude.
     * @param utmZoneChar   the UTM zone character representing the latitude.
     * @param eastingID     character representing the 100,000km easting square.
     * @param northingID    character representing the 100,000km easting square.
     * @param easting       easting in metres.
     * @param northing      northing in metres.
     * @param precision     the precision of the given easting and northing. Must be one of
     ...
     *                      Bessel 1841 ellipsoid; false is the parameters represent an MGRS
     *                      reference using the GRS 1980, International or WGS84 ellipsoids.
     * @throws IllegalArgumentException if any of the given parameters are invalid. Note that the
     ...
     *
     * @param ref a String to create an MGRS reference from.
     * @throws IllegalArgumentException if the given String is not correctly. formatted
     * @since 1.1
     */
     ...
     *
     * @param precision One of MGRSRef.PRECISION_1M, MGRSRef.PRECISION_10M,
