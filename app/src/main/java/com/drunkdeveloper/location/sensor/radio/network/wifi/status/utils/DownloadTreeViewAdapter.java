...
package com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils;
...
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.Const;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.R;
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.ui.MapDownloadActivity;
 ...
 */
public class DownloadTreeViewAdapter extends AbstractTreeViewAdapter<com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile> implements com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteDirListListener {
    ...
    TreeStateManager<com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile> manager;
    Map<com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteDirListTask, com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile> listTasks;
    ...
    public DownloadTreeViewAdapter(final Activity activity,
                                   final TreeStateManager<com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile> treeStateManager,
                                   final int numberOfLevels) {
        super(activity, treeStateManager, numberOfLevels);
        this.manager = treeStateManager;
        listTasks = new HashMap<com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteDirListTask, com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile>();
    ...
    @Override
    public View getNewChildView(final TreeNodeInfo<com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile> treeNodeInfo) {
    ...
    @Override
    public LinearLayout updateView(final View view, final TreeNodeInfo<com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile> treeNodeInfo) {
        final LinearLayout viewLayout = (LinearLayout) view;
        final com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile rfile = treeNodeInfo.getId();
    ...
    public void handleItemClick(final View view, final Object id) {
        final com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile rfile = (com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile) id;
        if (rfile.isDirectory) {
            if (rfile.children != null) {
                ...
                com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteDirListTask task = new com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteDirListTask(this, rfile);
    ...
    @Override
    public void onRemoteDirListReady(com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteDirListTask task, com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile[] rfiles) {
        com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile parent = listTasks.get(task);
        ...
        if (rfiles == null) {
            ...
            for (com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile rf : rfiles)
     ...
     */
    private void startDownload(com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile rfile, File mapFile, View view) {
        Uri uri = rfile.getUri();
        Uri destUri = Uri.fromFile(mapFile);
        try {
            DownloadManager.Request request = new DownloadManager.Request(uri);
            //request.setTitle(rfile.name);
            //request.setDescription("App map download");
    ...
    private class DownloadInfo {
         ...
         */
        private com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile remoteFile;
        ...
        private DownloadInfo(com.drunkdeveloper.location.sensor.radio.network.wifi.status.utils.RemoteFile remoteFile, Uri uri, File targetFile, long reference) {
            super();
