...
public abstract class CellTowerList<T extends CellTower> extends HashMap<String, T> {
	 ...
	 * {@link com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTower#SOURCE_CELL_LOCATION},
	 * {@link com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTower#SOURCE_NEIGHBORING_CELL_INFO}
	 * or {@link com.drunkdeveloper.location.sensor.radio.network.wifi.status.data.CellTower#SOURCE_CELL_INFO}.
	 */
