...
public class RefEll {
     ...
     * @since 1.1
     */
    public static final RefEll BESSEL_1841 = new RefEll(6377397.155, 299.1528128);
     ...
     * @since 1.1
     */
    public static final RefEll CLARKE_1866 = new RefEll(6378206.4, 294.9786982);
     ...
     * @since 1.1
     */
    public static final RefEll CLARKE_1880 = new RefEll(6378249.145, 293.465);
     ...
     * @since 1.1
     */
    public static final RefEll EVEREST_1830 = new RefEll(6377276.345, 300.8017);
     ...
     * @since 1.1
     */
    public static final RefEll GRS_1967 = new RefEll(6378160.0, 298.247167427);
     ...
     * @since 1.1
     */
    public static final RefEll GRS_1975 = new RefEll(6378140.0, 298.257);
     ...
     * @since 1.1
     */
    public static final RefEll GRS_1980 = new RefEll(6378137.0, 298.257222101);
     ...
     * @since 1.1
     */
    public static final RefEll SOUTH_AMERICAN_1969 = new RefEll(6378160.0, 298.25);
     ...
     * @since 1.1
     */
    public static final RefEll WGS66 = new RefEll(6378145.0, 298.25);
     ...
     * @since 1.1
     */
    public static final RefEll WGS72 = new RefEll(6378135.0, 298.26);
     ...
     *
     * @param maj semi-major axis
     * @param min semi-minor axis
     * @since 1.0
     */
