...
import com.drunkdeveloper.location.sensor.radio.network.wifi.status.PasvLocListenerService;
...
public class SettingsActivity extends AppCompatActivity implements OnPreferenceClickListener, OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mSharedPreferences.contains(Const.KEY_PREF_LOC_PROV)) {
            Set<String> defaultLocProvs = new HashSet<String>(Arrays.asList(LocationManager.GPS_PROVIDER, LocationManager.NETWORK_PROVIDER));
            SharedPreferences.Editor spEditor = mSharedPreferences.edit();
